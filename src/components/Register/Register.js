...
class Register extends React.Component {
	...
	onSubmitSignIn = () => {
		...
		fetch('https://infinite-depths-82115.herokuapp.com/register', {
			method: 'post',
				  ...
				  <div className="measure ">
				    <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
				      ...
				      <div className="mt3">
				        ...
				        <input onChange={this.onNameChange} className="pa2 input-reset ba bg-transparent hover-bg-black hover-white w-100" type="email" name="text"  id="name"/>
				      </div>
				      <div className="mt3">
